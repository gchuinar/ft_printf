...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/01/28 00:27:36 by gchuinar          #+#    #+#             */
/*   Updated: 2019/01/28 02:34:02 by gchuinar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
*/
static char *ft_sous_chiffre(char nb1, char nb2)
{
	int     nbr;
	char    *result;
...
/*	if (ft_sizecmp(nb1, nb2) == 1)
	...
	if (ft_sizecmp(nb1, nb2) == 0)
	{
		if (nb1[1] == '\0' && nb2[1] == '\0')
			result = ft_sous_chiffre(nb1[0], nb2[0]);
		else
